                    ...
                    return {
                        list: function()
                        {
                            ...
                            options = [
                                ...
                                {name: "gender", title: "Pohlavie", type: 'select', values: [{name: 'male', title: "Muž"}, {name: 'female', title: "Žena"}]},
                                {name: "age", title: "Vek", type: 'input'},
                                {name: "salary", title: "Čistá mzda", type: 'input'},
                                {name: "job", title: "Pracovné Odvetvie", type: 'select', values: [{name: 'it', title: 'Informačné technológie'}, {name: 'agro', title: 'Poľnohospodárstvo'}]},
